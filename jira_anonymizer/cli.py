...
def main(argv: list[str] | None = None) -> int:
    ...
    customfield_map_path = (
        Path(args.customfield_map) if args.customfield_map else None
    )
    if not customfield_map_path and config.customfield_map_path:
        customfield_map_path = Path(config.customfield_map_path)
